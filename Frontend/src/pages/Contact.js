                  ...
                  <ul className="ps-0">
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      ...
                      <address className="mb-0">
                        Fr. Conceicao Rodrigues College Of Engineering, Bnadra West, 413004
                      </address>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <BiPhoneCall className="fs-5" />
                      <a href="tel:+91 8264954234">+91 7447346225</a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <AiOutlineMail className="fs-5" />
                      <a href="mailto:crce.9193.cs@gmail.com">
                        crce.9193,cs@gmail.com
                      </a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
